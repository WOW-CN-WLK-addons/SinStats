...
local Basic, Base, Modifiers, Complete, Points, Value, Normal, Special = 2, 2, 3, 1, 1, 1, 1, 2
...
------------------------------
Ns.DefaultOrder = {
	{ stat="AP", onupdate=true, events={}, spell=46909, spellclass="Melee", widget={ type="CheckBox" }, options={ Enhanced_Base=true, }, subgroup=true, activeonload=true, },
	...
	{ stat="DMG", onupdate=true, events={}, spell=1329, spellclass="Melee", widget={ type="CheckBox" }, options={ Main_Off_Auto=true, Display_Average=true }, subgroup=true },
	{ stat="mDPS", onupdate=true, events={}, spell=35542, spellclass="Melee", widget={ type="CheckBox" }, options={ Main_Off_Auto=true, Display_Average=true }, subgroup=true },
	{ stat="RDMG", onupdate=true, events={}, spell=53228, spellclass="Ranged", widget={ type="CheckBox" }, options={ Max_Average_Damage=true, }, subgroup=true },
	{ stat="rDPS", onupdate=true, events={}, spell=19418, spellclass="Ranged", widget={ type="CheckBox" }, options={ Max_Average_Damage=true, }, subgroup=true },
	{ stat="Fire", onupdate=true, events={}, spell=86948, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Fire=true }, subgroup=true, activeonload=true, },
	{ stat="Frost", onupdate=true, events={}, spell=83157, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Frost=true }, subgroup=true },
	{ stat="Arcane", onupdate=true, events={}, spell=31572, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Arcane=true }, subgroup=true },
	{ stat="Shadow", onupdate=true, events={}, spell=47230, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Shadow=true }, subgroup=true },
	{ stat="Nature", onupdate=true, events={}, spell=48514, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Nature=true }, subgroup=true },
	{ stat="Holy", onupdate=true, events={}, spell=63542, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Holy=true }, subgroup=true },
	...
	{ stat="Mastery", onupdate=true, events={}, spell=86479, spellclass="Attributes", widget={ type="CheckBox" }, options={ Point_Rating=true, Decimals_Mastery=true, Cap_Mastery=true }, subgroup=true, activeonload=true, },
	{ stat="Strength", onupdate=true, events={}, spell=46917, spellclass="Attributes", widget={ type="CheckBox" }, options={ Show=true, Dec_Melee_Str=true }, subgroup=true },
	{ stat="Agility", onupdate=true, events={}, spell=51723, spellclass="Attributes", widget={ type="CheckBox" }, options={ Show=true, Dec_Melee_Agi=true }, subgroup=true },
	...
	{ stat="CritBoss", onupdate=true, events={}, spell=58426, spellclass="Melee", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Melee_Boss=true, Cap_Melee_CritBoss=true }, subgroup=true },
	{ stat="CritCap", onupdate=true, events={}, spell=51690, spellclass="Melee", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Melee_Cap=true }, subgroup=true },
	{ stat="RangedCrit", onupdate=true, events={}, spell=53241, spellclass="Ranged", widget={ type="CheckBox" }, options={ Percent_Rating=true, Dec_Ranged_Crit=true, Cap_Ranged_Crit=true, Display_Simulate=true }, subgroup=true },
	{ stat="RangedCritBoss", onupdate=true, events={}, spell=76577, spellclass="Ranged", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Ranged_CritBoss=true, Cap_Ranged_CritBoss=true }, subgroup=true },
	{ stat="Intellect", onupdate=true, events={}, spell=81206, spellclass="Attributes", widget={ type="CheckBox" }, options={ Show=true, Dec_Spell_Int=true }, subgroup=true },
	...
	{ stat="SpellCritBoss", onupdate=true, events={}, spell=44745, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Spell_Crit_Boss=true, Cap_Spell_CritBoss=true }, subgroup=true },
	{ stat="Hit", onupdate=true, events={}, spell=82925, spellclass="Melee", widget={ type="CheckBox" }, options={ Percent_Rating=true, Display_Decimals=true, Dec_Melee_Hit=true, Cap_Melee_Hit=true, }, subgroup=true },
	{ stat="RangedHit", onupdate=true, events={}, spell=35030, spellclass="Ranged", widget={ type="CheckBox" }, options={ Percent_Rating=true, Dec_Ranged_Hit=true, Cap_Ranged_Hit=true }, subgroup=true },
	...
	{ stat="HasteMelee", onupdate=true, events={}, spell=63150, spellclass="Melee", widget={ type="CheckBox" }, options={ Percent_Rating=true, Display_Basic=true, Dec_Melee_Haste=true, Cap_Melee_Haste=true }, subgroup=true },
	...
	{ stat="HasteCaster", onupdate=true, events={}, spell=30060, spellclass="Spell", widget={ type="CheckBox" }, options={ Percent_Rating=true, Display_Basic=true, Dec_Spell_Haste=true }, subgroup=true },
	{ stat="ArmorPen", onupdate=true, events={}, spell=84963, spellclass="Melee", widget={ type="CheckBox" }, options={ Percent_Rating=true, Display_Basic=true, Dec_Melee_Pen=true }, subgroup=true },
	...
	{ stat="Expertise", onupdate=true, events={}, spell=30920, spellclass="Melee", widget={ type="CheckBox" }, options={ Value_Rating=true, Display_Expertise=true, Dec_Melee_Exp=true, Cap_Melee_Exp=true, Display_Simulate=true }, subgroup=true },
	{ stat="MeleeMiss", onupdate=true, events={}, spell=79133, spellclass="Melee", widget={ type="CheckBox" }, options={ Level_Same_Boss=true, Dec_Melee_Miss=true, Display_Special=true, Display_Simulate=true }, subgroup=true },
	...
	{ stat="SpellMiss", onupdate=true, events={}, spell=85222, spellclass="Spell", widget={ type="CheckBox" }, options={ Level_Same_Boss=true, Dec_Spell_Miss=true, Display_Simulate=true }, subgroup=true },
	{ stat="Avoidance", onupdate=true, events={}, spell=61221, spellclass="Defense", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Def_Avoidance=true, Cap_Def_Avo=true, Add_Block=true }, subgroup=true, activeonload=true, },
	...
	{ stat="weaponSpeed", onupdate=true, events={}, spell=109935, spellclass="Melee", widget={ type="CheckBox" }, options={ Main_Off_Auto=true, Dec_Melee_AttSp=true }, subgroup=true },
	{ stat="CritReceived", onupdate=true, events={}, spell=46867, spellclass="Defense", widget={ type="CheckBox" }, options={ Chance_Reduction=true, Dec_Def_Crit=true, Display_Simulate=true }, subgroup=true },
	...
	{ stat="Spirit", onupdate=true, events={}, spell=48104, spellclass="Attributes", widget={ type="CheckBox" }, options={ Show=true, Dec_Spell_Spir=true }, subgroup=true },
	{ stat="ManaRegen", onupdate=true, events={}, spell=45234, spellclass="Spell", widget={ type="CheckBox" }, options={ Regen_Normal_Casting=true, Display_Basic=true, Dec_Spell_MP2=true }, subgroup=true },
	...
	{ stat="Mitigation", onupdate=true, events={}, spell=46945, spellclass="Defense", widget={ type="CheckBox" }, options={ Total_Modifiers=true, Dec_Def_Mit=true, Cap_Def_Mit=true }, subgroup=true },
	{ stat="EHP", onupdate=true, events={}, spell=85696, spellclass="Defense", widget={ type="CheckBox" }, options={ Show=true }, subgroup=true },
	{ stat="Resilience", onupdate=true, events={}, spell=74001, spellclass="Defense", widget={ type="CheckBox" }, options={ Dec_Def_Res=true }, subgroup=true },
	{ stat="Stamina", onupdate=true, events={}, spell=85730, spellclass="Attributes", widget={ type="CheckBox" }, options={ Show=true, Dec_Def_Stamina=true  }, subgroup=true },
	{ stat="Armor", onupdate=true, events={}, spell=86894, spellclass="Defense", widget={ type="CheckBox" }, options={ Enhanced_Base=true, Dec_Def_Armor=true, Cap_Def_Armor=true }, subgroup=true },
	...
	{ stat="Block", onupdate=true, events={}, spell=52127, spellclass="Defense", widget={ type="CheckBox" }, options={ Percent_Rating=true, Dec_Def_Block=true, Block_Damage=true, Display_Simulate=true }, subgroup=true },
	{ stat="petAP", onupdate=true, events={}, spell=53270, spellclass="Pet", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true, activeonload=true, },
	{ stat="petDMG", onupdate=true, events={}, spell=80553, spellclass="Pet", widget={ type="CheckBox" }, options={ Max_Average_Damage=true, }, subgroup=true },
	{ stat="petDPS", onupdate=true, events={}, spell=19623, spellclass="Pet", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
	{ stat="petSpell", onupdate=true, events={}, spell=3716, spellclass="Pet", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
	{ stat="petCrit", onupdate=true, events={}, spell=50334, spellclass="Pet", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
	{ stat="petAtkSpeed", onupdate=true, events={}, spell=78893, spellclass="Pet", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
	...
	{ stat="ValorPoints", events={ CURRENCY_DISPLAY_UPDATE=true, }, currency=396, spellclass="Currency", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true, activeonload=true, },
	{ stat="JusticePoints", events={ CURRENCY_DISPLAY_UPDATE=true, }, currency=395, spellclass="Currency", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
	...
	{ stat="Money", events={ PLAYER_MONEY=true, }, spell=67368, spellclass="Currency", widget={ type="CheckBox" }, options={ Show=true, Display_Gold=true, Decimals_Default=true, }, subgroup=true },
	...
	{ stat="ItemLevel", onupdate=true, events={}, spell=66666, spellclass="Misc", widget={ type="CheckBox" }, options={ Equip_Max=true, Dec_Misc_Ilvl=true }, subgroup=true },
	...
	{ stat="RepairCost", events={ UPDATE_INVENTORY_DURABILITY=true, }, spell=11209, spellclass="Misc", widget={ type="CheckBox" }, options={ Total_Equipped_Bags=true, }, subgroup=true },
	{ stat="Lag", onupdate=true, events={}, spell=33592, spellclass="Misc", widget={ type="CheckBox" }, options={ World_Realm=true, }, subgroup=true },
	{ stat="FPS", onupdate=true, events={}, updatespeed=1, spell=62695, spellclass="Misc", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
...
Ns.SpellClass = {
	...
	[1] = { stat="Attributes", icon="Attributes", },
	[2] = { stat="Melee", icon="Melee", },
	[3] = { stat="Defense", icon="Defense", },
	[4] = { stat="Ranged", icon="Ranged", },
	[5] = { stat="Spell", icon="Spell", },
	[6] = { stat="Pet", icon="Pet", },
	[7] = { stat="Resistance", icon="Resistance", },
	[8] = { stat="Currency", icon="Currency", },
...
Ns.Options = {
	...
	{ stat="Point_Rating", spellclass="Point_Rating", widget={ type="Radio", }, tooltip=false, default=1, labels={ "Points", "Rating", "Both"}, },
	...
	{ stat="Value_Rating", spellclass="Value_Rating", widget={ type="Radio", }, tooltip=true, default=1, labels={ "Value", "Rating", "Both"}, },
	...
	{ stat="Equip_Max", spellclass="Equip_Max", widget={ type="Radio", }, tooltip=true, default=1, labels={ "Equipped", "Max", "Both"}, },
	--
	...
	{ stat="Block_Damage", spellclass="Block_Damage", widget={ type="CheckBox", }, tooltip=true, default=false, labels={ "Block_Damage"}, },
	{ stat="Display_Special", spellclass="Display_Special", widget={ type="CheckBox", }, tooltip=true, default=false, labels={ "Display_Special"}, },
	...
	-- Melee cap boxes
	{ stat="Cap_Melee_Crit", spellclass="Cap_Melee_Crit", default=100, tooltip=true, widget={ type="EditBox", width=60, height=20, numeric=true, format="%.2f%%", }, },
	...
	{ stat="Cap_Melee_Exp", spellclass="Cap_Melee_Exp", default=26, tooltip=true, widget={ type="EditBox", width=60, height=20, numeric=true, format="%.2f", }, },
